...
public class ChangePasswordFragment extends Fragment {
    ...
    private EditText newPassTxt1;
    private EditText newPassTxt2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //get Views
        oldPassTxt=(EditText)view.findViewById(R.id.changePassOldTxt);
        newPassTxt1=(EditText)view.findViewById(R.id.changePassNewTxt);
        newPassTxt2=(EditText)view.findViewById(R.id.changePassNew2Txt);
        confirmBtn=(Button)view.findViewById(R.id.changePassConfirmBtn);
